...
def get_args_parser(add_help=True):
    ...
    parser = argparse.ArgumentParser(description="Train ...", add_help=add_help)    
    ...
    parser.add_argument(
        "--lr-min", default=1e-6, type=float, help="minimum lr of lr schedule (default: 0.0)")
    parser.add_argument(
        "--print-freq", default=10, type=int, help="print frequency")
    parser.add_argument("--output-dir", default="experiments/saplm_full", type=str, help="path to save outputs")
    parser.add_argument(
    ...
    parser.add_argument(
        "--clip-grad-norm", default=1.0, type=float, help="the maximum gradient norm (default None)")
    ...
    parser.add_argument("--grad_accum_iter",type=int,default=64,help="grad accumulation")
    parser.add_argument("--amp", action="store_true", help="Use torch.cuda.amp for mixed precision training")
    parser.add_argument("--dist_backend", default="nccl", type=str, help="distributed backend (default: nccl)")
